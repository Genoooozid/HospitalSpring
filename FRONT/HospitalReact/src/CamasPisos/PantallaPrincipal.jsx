...
const PantallaPrincipal = () => {
  ...
  return (
    <Layout>
      ...
      <GestionarPisos show={showModalPisos} onHide={() => setShowModalPisos(false)} />
            ...
            {camas.length > 0 ? (
              camas.map((cama) => (
                <div
                  ...
                  onClick={() => handleDesocuparCama(cama)}
                >
                  <div className="card p-3 text-center" style={{ width: '250px' }}>
                    ...
                    <p className="fw-bold mt-2">
                      {cama.estado === 'Ocupada' ? `Ocupada por ${cama.paciente}` : 'Desocupada'}
                    </p>
