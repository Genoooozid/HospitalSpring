...
const AgregarSecretaria = ({ show, onClose, pisos, loadingPisos, triggerRefresh }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('http://localhost:8080/api/usuarios/persona/secretaria', formData, {
                headers: {
                ...
                <form onSubmit={handleSubmit} className="modal-form">
                    ...
                    <div className="form-row">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" name="materno" value={formData.materno} onChange={handleChange} required />
                        </div>
                    </div>
